...
async function handleExternalDataImport(request: NextRequest) {
...
async function handleExternalDataQuery(request: NextRequest) {
...
export const POST = withErrorHandling(handleExternalDataImport);
export const GET = withErrorHandling(handleExternalDataQuery); 