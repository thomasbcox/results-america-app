...
-- ============================================================================
-- 
-- This file contains sample data for the statistics table.
-- Statistics are the actual measures and indicators.
--
-- IMPORTANT: Run seed-categories.sql and seed-data-sources.sql first!
-- This script assumes categories and data sources are already loaded.
--
-- Usage: Run this after creating the database schema and seeding categories/data sources
-- ============================================================================
...
-- Note: category_id and data_source_id will be auto-assigned based on existing data
...
-- Verify the insertions with category and data source names
SELECT 
    s.id,
    s.ra_number,
    s.name,
